...
const updateMapping = function *(mpid,body){
  debug('updating metering plan',mpid);
	var clone =sampleMetering;
	clone[mpid] = body.mapping;
...
routes.post(
  '/v1/provisioning/metering/:resource_id',
  function *(req) {
